...
describe('API routes', () => {
  ...
  it('GET /tools returns tools for latest collection', async () => {
    ...
    toolRepo.upsert({ id: 'tool1', collection_id: 'col1', server_id: 'srv1', name: 'read_file', description: 'Reads a file', input_schema: null, capabilities: JSON.stringify([Capability.READ_LOCAL_FILE]), source_role: JSON.stringify(['DATA_SOURCE']), is_untrusted: 0, is_instruction_capable: 0, content_origin: 'local', trust_zone: null, risk_score: 30, created_at: now });
